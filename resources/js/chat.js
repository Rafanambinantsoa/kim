...
export default class Chat {
    constructor() {
        ...
        this.kim = document.querySelector("#chat-wrapper").dataset.username;
    ...
    displayMessageFromServer(data) {
        ...
        //On met une sorte de comparaison genre si le nom de l'envoyeeur est le meme que celui qui est connecter donc on affiche pas le message de retour
        //sinon on affiche
        if(data.username == this.kim){
            console.log("mitovy")
            this.chatLog.insertAdjacentHTML(
                "beforeend",
                DOMPurify.sanitize(``)
